...
export const servicesData: ServiceItem[] = [
    ...
    faqs: [
      {
        ...
        answer:
          "Kullandığımız UV korumalı laminasyon ve kaliteli pigment mürekkepler sayesinde iç mekan baskılarımız solmaya karşı 5 yıldan fazla dayanıklılık garantisine sahiptir.",
      },
      {
  ...
  },
  {
    ...
    shortDesc:
      "Zorlu hava şartlarına dayanıklı vinil (branda), delikli mesh ve bina cephe giydirme baskıları.",
    badge: "Ağır Gramaj Dökme Vinil",
    codeNumber: "02",
    unitPriceEstimate: 180,
    fullDescription:
      "Dış mekan tanıtım projeleriniz için fırtına, yağmur ve yoğun güneş ışığına dayanıklı ağır gramajlı dökme vinil ve rüzgar geçiren delikli mesh baskı üretimi sağlamaktayız. Şerifali tesisimizde ürettiğimiz vinil baskılar kolon dikişli, kapsüllü ve montaja hazır halde teslim edilir.",
    features: [
    ...
    faqs: [
      {
        ...
        answer:
          "Mesh baskılar üzerindeki mikro delikler sayesinde rüzgarı geçirir ve yelken etkisi oluşturmaz. Kenar kolon takviyeleri ile ekstra sağlamlaştırılır.",
      },
    ],
    seoKeywords: [
  ...
  },
  {
    ...
    shortDesc:
      "Pleksi kutu harf, alüminyum kompozit tabela, totem ve iç mekan yönlendirme levhaları imalatı.",
    badge: "Alüminyum & LED İmalat",
    codeNumber: "03",
    unitPriceEstimate: 1200,
    fullDescription:
      "Armonitex & UPD Açıkhava bünyesinde alüminyum kompozit, pleksi, paslanmaz krom harf ve yüksek tasarruflu Samsung LED modüller ile kurumunuza özel tabela üretimi gerçekleştirmekteyiz. Tasarımdan CNC kesim, kaynak ve montaj aşamalarına kadar tüm süreç fabrika bünyemizde tamamlanır.",
    features: [
    ...
    faqs: [
      {
        ...
        answer:
          "Kullandığımız yeni nesil IP67 LED modüller geleneksel floresan sistemlere göre %75 daha az elektrik tüketir.",
      },
    ],
    seoKeywords: [
  ...
  },
  {
    ...
    shortDesc:
      "Ticari filo araç kaplama, One Way Vision delikli folyo ve cam/bina cephe grafik uygulamaları.",
    badge: "Filo & Cephe Grafiği",
    codeNumber: "04",
    unitPriceEstimate: 350,
    fullDescription:
      "Şirket ticari araçlarınız ve bina cam cepheleriniz için cast folyo ve One Way Vision (delikli cam folyosu) malzemeleri ile profesyonel kaplama hizmeti veriyoruz. Tesisimizdeki ısı korumalı giydirme alanında uzman ustalarımız tarafından sıfır hava kabarcığı ile uygulama tamamlanır.",
    features: [
    ...
    faqs: [
      {
        ...
        answer:
          "Hayır. Kaliteli cast folyolarımız orijinal araç boyasını dış etkenlerden, çiziklerden ve güneş solmasından korur.",
      },
    ],
    seoKeywords: [
  ...
  },
  {
    ...
    shortDesc:
      "Roll-up stand, örümcek (popup) stand, plaj bayrağı ve fuar sergileme panoları imalatı.",
    badge: "Modüler Alüminyum Gövde",
    codeNumber: "05",
    unitPriceEstimate: 450,
    fullDescription:
      "Fuar, lansman, seminer ve Mağaza içi etkinlikleriniz için kolay kurulup taşınabilir Roll-up mekanizmaları, örümcek standlar ve plaj bayrakları üretiyoruz. Alüminyum gövdeli, taşıma çantalı ve yeniden baskı değişimi yapılabilir modüler mekanizmalar sunulmaktadır.",
    features: [
    ...
    faqs: [
      {
        ...
        answer:
          "Hayır. Kullandığımız özel Anti-Curl (kıvrılma önleyici) gri arkalı film malzemesi sayesinde Roll-up görselleriniz yıllarca düz kalır.",
      },
    ],
    seoKeywords: [
