...
export const metadata: Metadata = {
  ...
  description:
    "1998'den bu yana 28 yıllık tecrübesiyle Armoni Reklam & UPD Reklam bünyesinde dijital baskı ve açıkhava reklam üretimi.",
  alternates: {
    canonical: "/kurumsal",
  },
  openGraph: {
    ...
    description:
      "28 yıllık sektör liderliği, yüksek kapasiteli baskı parkuru ve müşteri odaklı çözümlerimiz.",
    ...
    <div className="min-h-screen bg-white-token flex flex-col font-sans text-main-token">
      ...
      <main className="flex-1 max-w-5xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
        ...
        <section className="bg-navy-token text-white-token p-8 md:p-12 rounded-2xl shadow-md space-y-4">
          <span className="badge-cyan-token font-bold text-xs">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="card-token p-6 sm:p-8 bg-white-token space-y-4">
            <h2 className="text-xl font-bold text-main-token border-b border-token pb-2">
              Tarihçemiz &amp; Kuruluş
            </h2>
            <p className="text-subtle-token text-sm leading-relaxed">
              ...
              Şerifali tesislerinde yüksek kapasiteli üretim gerçekleştiren bir entegre tesis haline
              gelmiştir.
            </p>
            <p className="text-subtle-token text-sm leading-relaxed">
          ...
          <div className="card-token p-6 sm:p-8 bg-white-token space-y-4">
            ...
            <ul className="space-y-2 text-xs font-semibold text-main-token">
              <li className="flex items-center gap-2">
                <span className="text-brand-token font-bold">✓</span> %100 Orijinal Malzeme
                Garantisi
              </li>
              <li className="flex items-center gap-2">
                <span className="text-brand-token font-bold">✓</span> 7/24 Kesintisiz Vardiyalı
                İmalat
              </li>
              <li className="flex items-center gap-2">
                <span className="text-brand-token font-bold">✓</span> Profesyonel Sahada Montaj
                Ekibi
              </li>
            </ul>
          </div>
        ...
        <section className="pt-6">
          <h2 className="text-2xl font-bold text-main-token mb-6 text-center">
            Tesis Altyapımız ve Üretim Standartlarımız
          </h2>
          <ArchitectureTabs />
        </section>
      </main>
