...
export default function Logo({ className = "w-[350px] h-[100px]" }: LogoProps) {
  return (
    <div
      className={`relative flex items-center justify-between px-4 py-2 bg-gradient-to-r from-white via-slate-50 to-teal-50/50 text-slate-900 rounded-xl shadow-md border border-slate-200 overflow-hidden select-none ${className}`}
    ...
    >
      ...
      <div className="flex items-center gap-3 z-10">
        <div className="w-14 h-14 rounded-lg bg-teal-50 border border-teal-200 flex items-center justify-center text-teal-600 shadow-sm">
        ...
        <div className="flex flex-col">
          <div className="flex items-center gap-1.5">
            <span className="text-xl font-extrabold tracking-tight text-slate-900 uppercase font-sans">
          ...
          <span className="text-[9px] font-mono text-teal-600/70 tracking-tighter">
            ARM-TRV-350X100
          </span>
        </div>
      </div>
      ...
      <div className="hidden sm:flex flex-col items-end justify-center border-l border-slate-200 pl-3 z-10">
